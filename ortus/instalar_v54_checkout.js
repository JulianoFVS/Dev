...
console.log('💳 Instalando V54: Tela de Checkout e Fluxo de Assinatura...');
...
// ======================================================
// 1. TELA DE CHECKOUT (app/checkout/page.tsx)
// ======================================================
const checkoutPage = `
'use client';
...
// ======================================================
// 2. ATUALIZAR LANDING PAGE (Links para /checkout)
// ======================================================
const landingPage = `
'use client';
import Link from 'next/link';
...
// ======================================================
// 3. PÁGINA DE CADASTRO (Visual de "Pagamento Confirmado")
// ======================================================
const cadastroPage = `
'use client';
import { useState } from 'react';
...
salvarArquivo('app/site/page.tsx', landingPage); // ou app/page.tsx dependendo de onde está sua home
salvarArquivo('app/page.tsx', landingPage); // Atualiza a raiz também por garantia
