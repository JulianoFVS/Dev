...
console.log('🚀 Instalando V51: Landing Page e Termos de Uso (Transformando em Produto)...');
...
// ======================================================
// 1. LANDING PAGE (VENDEDORA) - app/site/page.tsx
// ======================================================
const landingPage = `
'use client';
...
// ======================================================
// 2. PÁGINA DE TERMOS (JURÍDICO) - app/termos/page.tsx
// ======================================================
const termosPage = `
import Link from 'next/link';
...
salvarArquivo('app/site/page.tsx', landingPage);
salvarArquivo('app/termos/page.tsx', termosPage);