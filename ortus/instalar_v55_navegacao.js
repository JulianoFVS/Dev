...
console.log('🧭 Instalando V55: Botão Voltar no Login e Logo Clicável no Dashboard...');
...
// ======================================================
// 1. LOGIN COM BOTÃO VOLTAR (app/login/page.tsx)
// ======================================================
const loginPage = `
'use client';
...
// ======================================================
// 2. LOGO CLICÁVEL NO MENU (components/AuthGuard.tsx)
// ======================================================
const authGuard = `
'use client';
