...
import { 
  ...
  Search, Printer, ChevronDown, ChevronUp, ArrowDownCircle, Trash2, RefreshCw, Loader2
} from 'lucide-react';
...
export default function Financeiro() {
  ...
  async function carregarDados() {
    ...
    // Unificação (AQUI ESTAVA O ERRO: Adicionei tipagem ': any' para evitar erro de build)
    ...
    <div className="space-y-6 animate-fade-in pb-20 max-w-6xl mx-auto">
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-2">
            ...
            <button onClick={carregarDados} className="p-2 text-slate-400 hover:text-teal-600 rounded-lg hover:bg-slate-100 transition-colors" title="Atualizar">
