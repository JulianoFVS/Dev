...
import LandingPreviewScale from './LandingPreviewScale';
  ...
  return (
    <section className="overflow-x-hidden bg-white pb-8 pt-8 md:pb-16 md:pt-16">
      ...
      <div className="relative mt-8 md:mt-14">
        ...
        <div className="group/preview relative z-10 mx-auto w-full max-w-[1120px] px-4 md:px-6">
          <div className="transition-transform duration-500 ease-out md:group-hover/preview:-translate-y-1">
            <LandingPreviewScale>
