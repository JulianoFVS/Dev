...
import {
    ...
    Smile, FolderOpen, Bell, BarChart3, X, ArrowRight, Command, ClipboardList, ShieldCheck,
} from 'lucide-react';
...
export default function Omnibar({ moduleAccess, isAdmin }: OmnibarProps) {
    ...
    const navItems = useMemo<OmniResult[]>(() => {
        const base: OmniResult[] = [
            ...
            { id: 'nav_inbox', label: 'Notificações', sublabel: 'Central de avisos', icon: <Bell size={16} className="text-purple-500"/>, action: () => router.push('/inbox?tab=alertas'), category: 'navegacao' },
