...
console.log('🛠️ Corrigindo erro de tipagem nos Checkboxes do Prontuário...');
...
fs.writeFileSync(targetPath, prontuarioFinal.trim());

console.log('✅ Tipagem dos Checkboxes Corrigida!');