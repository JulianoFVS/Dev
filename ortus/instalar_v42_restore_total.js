...
console.log('🛠️ Instalando V42: Restauração TOTAL (Foto, Histórico, Anamnese, Filtros)...');
...
// ======================================================
// 1. FINANCEIRO (Filtros de Data + Impressão)
// ======================================================
...
// ======================================================
// 2. PACIENTES (Abas, Anamnese Rica, Histórico Clicável)
// ======================================================
const pacientesPage = `
'use client';
import { useState, useEffect } from 'react';
...
// ======================================================
// 3. PERFIL (Com Upload de Foto e Edição)
// ======================================================
const perfilPage = `
'use client';
import { useState, useEffect } from 'react';
